import ParticipantsDisplay from "./participants-display-section";
...
export function activate() {
  ...
  // and list mode.
  ComponentRegistry.register(ParticipantsDisplay, {
...
export function deactivate() {
  ComponentRegistry.unregister(ParticipantsDisplay);
}
